      ...
      >
        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center gap-12 relative z-10">
          ...
          >
            ...
            >
              Unlock every insight from your social media analytics.
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                <Link to="AnalyzerForm">Discover AI →</Link>
              </motion.div>
              <motion.a
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                href="https://www.youtube.com/watch?v=ibWsN2dP1KQ"
                target="_blank"
          ...
          >
            <div className="relative">
              {/* Subtle glow effect */}
              <div className="absolute -inset-2 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-full blur-xl mt-2"></div>
              {/* Animation */}
              <Lottie
